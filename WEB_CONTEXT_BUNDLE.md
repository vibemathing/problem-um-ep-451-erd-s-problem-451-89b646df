...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-451-erd-s-problem-451-89b646df-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-451"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-451-erd-s-problem-451-89b646df-v1",
      "problem_contract_sha256": "dae02c8d9cfdacad68be297981b2377603c0b02eff69f4097cf45f9b15522329",
      "problem_id": "problem:um-ep-451-erd-s-problem-451-89b646df",
      "route_id": "route:um-ep-451-erd-s-problem-451-89b646df-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-451-erd-s-problem-451-89b646df-source-fidelity-01",
      "graph_id": "graph:um-ep-451-erd-s-problem-451-89b646df-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-451-erd-s-problem-451-89b646df-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-451-erd-s-problem-451-89b646df-root",
          "statement": {
          ...
          "statement_sha256": "4e4fb8fd3d6afe8fb155813d41e3aa8a37b6dd930bafd1062c29482015db7279"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-451-erd-s-problem-451-89b646df-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-451-erd-s-problem-451-89b646df-root",
      "route_id": "route:um-ep-451-erd-s-problem-451-89b646df-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-451-3068b6b596db",
        "url": "https://www.unsolvedmath.com/problems/EP-451"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
